/**
 * @fileOverview The Kashing button which adds selected shortcode to your node.
 *
 */
...
CKEDITOR.plugins.add( 'colorbutton', {
	...
	icons: 'bgcolor,textcolor,kashing_icon', // %REMOVE_LINE_CORE%
	...
	init: function( editor ) {
		...
		if ( !CKEDITOR.env.hc ) {
			...
			addButton( 'KashingShortcode', 'back', lang.bgColorTitle, 20, bgOptions );
		}
